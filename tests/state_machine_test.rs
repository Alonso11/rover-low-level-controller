...
use rover_low_level_controller::state_machine::{
    ...
    Response, RoverState, SafetyState, SensorFrame,
};
...
fn test_format_tlm_normal_no_stall() {
    ...
    assert_eq!(format_response(resp, &mut buf), b"TLM:NORMAL:000000:0ms:0mV:0mA:0:0:0:0:0:0:0C:0:0:0:0:0:0C:0mm:0:0\n");
}
...
fn test_format_tlm_fault_with_stall() {
    ...
    assert_eq!(format_response(resp, &mut buf), b"TLM:FAULT:000110:0ms:0mV:0mA:0:0:0:0:0:0:0C:0:0:0:0:0:0C:0mm:0:0\n");
}
...
fn test_format_tlm_warn() {
    ...
    assert_eq!(format_response(resp, &mut buf), b"TLM:WARN:000000:0ms:0mV:0mA:0:0:0:0:0:0:0C:0:0:0:0:0:0C:0mm:0:0\n");
}
...
fn test_format_tlm_with_sensor_data() {
    ...
    assert_eq!(
        ...
        b"TLM:NORMAL:000000:0ms:0mV:0mA:1200:980:1100:1050:1200:1180:27C:30:31:29:30:28:32C:0mm:0:0\n"
    );
}
...
fn test_format_tlm_with_negative_current() {
    ...
    assert_eq!(
        format_response(resp, &mut buf),
        b"TLM:NORMAL:000000:0ms:11400mV:-3200mA:-500:0:1000:-1000:2500:-2500:-5C:0:0:0:0:0:0C:0mm:0:0\n"
    );
}
...
fn test_format_tlm_timestamp_nonzero() {
    ...
    assert!(result.starts_with(b"TLM:NORMAL:000000:86400000ms:0mV:0mA:"));
}
